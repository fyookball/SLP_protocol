...
<table>
  ...
  <tr>
    ...
    <td>OP_RETURN
<lokad id: \x00SLP> (4 bytes, ascii)
<version / token_type> (1 to 2 bytes)
<SLP cmd: COMM> (4 bytes, ascii) 
<token_id> (32 bytes)
<for_bitcoin_block_height> (8 bytes)
...
**Transaction Validation Security**** Mo****del**
...
This document is released under the terms of the [MIT License](https://mit-license.org/). 
