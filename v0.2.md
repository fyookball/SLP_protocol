...
<sup>1 The token ticker, document url, and document hash fields listed within this transaction should follow the format proposed by Andrew Stone in the GROUP token proposal.</sup>
