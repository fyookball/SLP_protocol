...
<table>
  ...
  <tr>
    ...
    <td></td>
    <td>OP_RETURN<BR>
&lt;Lokad identifier: \x00SLP&gt; (4 bytes, ascii)<BR>
&lt;version / token_type&gt; (1 to 2 bytes, big-endian)<BR>
...
&lt;unit_decimal_place&gt; (1 byte between 0x00-0x09)<BR>
...
<sup>1 The token ticker, document url, and document hash fields listed within this transaction should follow the format proposed by Andrew Stone in the GROUP token proposal.

2 The Lokad identifier is registered as “0x00534c50” (the ascii equivalent of SLP). Inquiries and additional information about the Lokad system of OP_RETURN protocol identifiers can be found at https://github.com/Lokad/Terab maintained by Joannes Vermorel.
...
<table>
  ...
  <tr>
    <td>Alice UTXO #1-n w/ token_id tokens </td>
    <td></td>
    <td>OP_RETURN<BR>
&lt;lokad id: \x00SLP&gt; (4 bytes, ascii)<BR>
&lt;version / token_type&gt; (1 to 2 bytes, big-endian)<BR>
...
&lt;token_id&gt; (32 bytes)<BR>
&lt;token_output_quantity1&gt; (8 bytes, for vout: 1, big-endian)<BR>
...<BR>
&lt;token_output_quantityN&gt; (optional, 8 bytes, vout: N, big-endian)<BR>
...<BR>
...
&lt;token_id&gt; (32 bytes)<BR>
&lt;for_bitcoin_block_height&gt; (8 bytes, big-endian)<BR>
