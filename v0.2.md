...
[Token Genesis Transaction](#token-genesis-transaction)

[Token Minting Transaction](#token-minting-transaction)


[Spend (Transfer) Transaction](#spend-transaction)

[Checksum Commitment Transaction](#checksum-commitment-transaction)
...
[Guidelines for computing SLP validity](#guidelines-for-computing-slp-validity)

[Caching validity results](#caching-validity-results)
[Proxies](#proxies)
[BitDB](#bitdb)
[Economic Implications](#economic-implications)
[Appendix A: Regulated Security Tokens](#appenix-a-regulated-security-tokens)
[Copyright](#copyright)
